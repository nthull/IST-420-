...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- Need to lengthen recipeSuggestor textbox--%>
        <ul>
            ...
            Search for a Recipe!
            <table>
             <tr><td><asp:TextBox ID="recipeSuggestor" runat="server" >Enter a food in here to find recipes for it!</asp:TextBox></td></tr>
             <tr><td><asp:Button ID="recipeSuggestButton" Text="Click for Recipe Suggestions!" OnClick="SearchNewRecipe" runat="server"/></td></tr>
             <%-- Need to lengthen both restSuggest textboxes--%>
            <tr><td>Search for a Restaurant!</td></tr>
             <tr><td><asp:TextBox ID="restaurantFoodSuggestor" Text="Enter a food for restaurant suggestions" runat="server" ></asp:TextBox>
             <asp:TextBox ID="restaurantLocSuggestor" Text="Enter a location for restaurant suggestions" runat="server" ></asp:TextBox></td></tr>
